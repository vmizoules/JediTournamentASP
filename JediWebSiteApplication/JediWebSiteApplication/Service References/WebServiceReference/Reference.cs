...
namespace JediWebSiteApplication.WebServiceReference {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="UtilisateurContract", Namespace="http://schemas.datacontract.org/2004/07/JediService.Models")]
    [System.SerializableAttribute()]
    public partial class UtilisateurContract : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
    ...
    public interface IJediWebService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IJediWebService/CreateUtilisateur", ReplyAction="http://tempuri.org/IJediWebService/CreateUtilisateurResponse")]
        void CreateUtilisateur(JediWebSiteApplication.WebServiceReference.UtilisateurContract utilisateur);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IJediWebService/CreateUtilisateur", ReplyAction="http://tempuri.org/IJediWebService/CreateUtilisateurResponse")]
        System.Threading.Tasks.Task CreateUtilisateurAsync(JediWebSiteApplication.WebServiceReference.UtilisateurContract utilisateur);
        ...
        JediWebSiteApplication.WebServiceReference.UtilisateurContract CheckLoginPassword(string login, string passwd);
    ...
    public partial class JediWebServiceClient : System.ServiceModel.ClientBase<JediWebSiteApplication.WebServiceReference.IJediWebService>, JediWebSiteApplication.WebServiceReference.IJediWebService {
        ...
        public void CreateUtilisateur(JediWebSiteApplication.WebServiceReference.UtilisateurContract utilisateur) {
            base.Channel.CreateUtilisateur(utilisateur);
        }
        
        public System.Threading.Tasks.Task CreateUtilisateurAsync(JediWebSiteApplication.WebServiceReference.UtilisateurContract utilisateur) {
            return base.Channel.CreateUtilisateurAsync(utilisateur);
        }
        
        public JediWebSiteApplication.WebServiceReference.UtilisateurContract CheckLoginPassword(string login, string passwd) {
            return base.Channel.CheckLoginPassword(login, passwd);
        }
